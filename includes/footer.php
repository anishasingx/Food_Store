<footer>
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    <h5>About</h5>
                    <p>
                        Fresh Food Store is a modern grocery brand focused on providing high-quality, farm-fresh products with a strong emphasis on health, sustainability, and natural taste.
                    </p>
                </div>
                <div class="col-md-3">
                    <h5>Links</h5>
                ...
                <div class="col-md-3">
                     ...
                     <ul>
                         <li>
                            <a href="tel:+917004270485"><i class="fa fa-phone"></i> 7004270485</a>
                        </li>
                        <li>
                            <a href="mailto:riteshsony2@gmail.com"><i class="fa fa-envelope"></i> riteshsony2@gmail.com</a>
                         </li>
                     </ul>
                ...
                <div class="col-md-3">
                     ...
                     <ul class="mb-0">
                         <li style="height: 200px">
                             <div class="mockup">
                                 <img class="rounded" src="<?php echo APPURL; ?>/assets/img/logo.png">
                             </div>
                         </li>
                     </ul>
                </div>
        ...
        <p class="copyright">&copy; 2026 Food Store | Created By Anisha & Ritesh. All rights reserved.</p>
    </footer>
