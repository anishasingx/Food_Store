<?php 
    ...
    session_start();
    define("APPURL","http://localhost/FoodStore");
    
    define("IMGURLCATEGORY", "http://localhost/FoodStore/admin-panel/categories-admins/img_category");
    define("IMGURLPRODUCT", "http://localhost/FoodStore/admin-panel/products-admins/img_product");
...
<html>
<head>
    <title>Food Store | Groceries Organic Store</title>
    <meta charset="utf-8">
