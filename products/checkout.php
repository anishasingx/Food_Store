...
<?php 
    ...
    if(isset($_SESSION['price'])) {
        $myprice = (int) $_SESSION['price'];
        $_SESSION['total_price'] = $myprice + 20;
    }
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <?php foreach($allProducts as $product) : ?>
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    INR <?php echo $product->pro_price; ?>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    ...
                                    <tfooter>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <strong>INR <?php echo $myprice = ((int) $_SESSION['price']) + 20; ?></strong>
                                            </td>
                                        </tr>
                                    </tfooter>
                                </table>
