<?php 
  ...
  session_start();
  define("ADMINURL", "http://localhost/FoodStore/admin-panel");
...
<div id="wrapper">
    <nav class="navbar header-top fixed-top navbar-expand-lg  navbar-dark bg-dark">
      ...
      <a class="navbar-brand" href="#">
        <img src="http://localhost/FoodStore/assets/img/logo/logo.png" height="80px" alt="">
      </a>
      ...
      <div class="collapse navbar-collapse " id="navbarText">
        <?php if(isset($_SESSION['adminname'])) : ?>
          <ul class="navbar-nav side-nav mt-5" >
            <li class="nav-item">
        ...
        <ul class="navbar-nav ml-md-auto d-md-flex">
          <?php if(!isset($_SESSION['adminname'])) : ?>
          <li class="nav-item">
            <a class="nav-link fw-bold fs-1" href="<?php echo ADMINURL; ?>/admins/login-admins.php">Login
              <span class="sr-only">(current)</span>
            </a>
          </li>
          <?php else: ?>
